...
void searchFunction(Info* information)   //Function for search
{
    clear();
    refresh();
...
void addFunction(Info* information) //Function for Addition
    {
    clear(); //clear screen
    refresh();
...
void deleteFunction(Info* information)   //Function for deletion
    {
    clear();
    refresh();
